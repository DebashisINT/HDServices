package com.breezefieldhdservices.features.logoutsync.presentation
...
import com.breezefieldhdservices.CustomConstants


import com.breezefieldhdservices.R
import com.breezefieldhdservices.app.AppDatabase
...
import com.breezefieldhdservices.app.utils.Toaster
import com.breezefieldhdservices.base.BaseResponse
import com.breezefieldhdservices.base.presentation.BaseActivity
import com.breezefieldhdservices.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldhdservices.features.billing.api.AddBillingRepoProvider
import com.breezefieldhdservices.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldhdservices.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldhdservices.features.document.model.AddEditDocumentInputParams
import com.breezefieldhdservices.features.document.model.DocumentAttachmentModel
...
import com.breezefieldhdservices.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldhdservices.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldhdservices.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldhdservices.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldhdservices.features.orderhistory.model.*
...
import com.breezefieldhdservices.features.quotation.model.AddQuotInputModel
import com.breezefieldhdservices.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldhdservices.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldhdservices.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldhdservices.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldhdservices.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldhdservices.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldhdservices.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldhdservices.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldhdservices.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldhdservices.mappackage.SendBrod
import com.breezefieldhdservices.widgets.AppCustomTextView
import com.breezefieldhdservices.MonitorService
import com.breezefieldhdservices.MySingleton
import com.breezefieldhdservices.app.AlarmReceiver
import com.breezefieldhdservices.features.addshop.model.*
import com.breezefieldhdservices.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezefieldhdservices.features.addshop.presentation.ShopExtraContactReq
import com.breezefieldhdservices.features.addshop.presentation.multiContactRequestData
...
import com.breezefieldhdservices.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldhdservices.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldhdservices.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldhdservices.features.orderITC.SyncOpptProductL
import com.breezefieldhdservices.features.orderITC.SyncOrd
import com.breezefieldhdservices.features.orderITC.SyncOrdProductL
import com.breezefieldhdservices.features.performance.model.Gps_status_list
import com.breezefieldhdservices.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldhdservices.features.returnsOrder.ReturnProductList
import com.breezefieldhdservices.features.returnsOrder.ReturnRequest
import com.breezefieldhdservices.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldhdservices.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldhdservices/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldhdserviceslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldhdserviceslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldhdserviceslogsample/log.zip").path);
