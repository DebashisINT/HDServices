package com.breezefieldhdservices.features.dashboard.presentation
...
import com.breezefieldhdservices.*
import com.breezefieldhdservices.R
import com.breezefieldhdservices.app.*
import com.breezefieldhdservices.app.NewFileUtils.browseDocuments
import com.breezefieldhdservices.app.NewFileUtils.browsePDFDocuments
import com.breezefieldhdservices.app.NewFileUtils.getExtension
import com.breezefieldhdservices.app.domain.*
import com.breezefieldhdservices.app.types.DashboardType
import com.breezefieldhdservices.app.types.FragType
import com.breezefieldhdservices.app.types.TopBarConfig
import com.breezefieldhdservices.app.uiaction.DisplayAlert
import com.breezefieldhdservices.app.utils.*
import com.breezefieldhdservices.app.utils.AppUtils.Companion.isProfile
import com.breezefieldhdservices.base.BaseResponse
import com.breezefieldhdservices.base.presentation.BaseActivity
import com.breezefieldhdservices.base.presentation.BaseFragment
import com.breezefieldhdservices.features.NewQuotation.*
import com.breezefieldhdservices.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldhdservices.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldhdservices.features.SearchLocation.SearchLocationFragment
import com.breezefieldhdservices.features.SearchLocation.locationInfoModel
import com.breezefieldhdservices.features.TA.ViewAllTAListFragment
import com.breezefieldhdservices.features.achievement.AchievementFragment
import com.breezefieldhdservices.features.activities.presentation.*
import com.breezefieldhdservices.features.addAttendence.*
import com.breezefieldhdservices.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldhdservices.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldhdservices.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldhdservices.features.addAttendence.model.GetReportToResponse
import com.breezefieldhdservices.features.addAttendence.model.Leave_list_Response
import com.breezefieldhdservices.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldhdservices.features.addshop.presentation.AddShopFragment
import com.breezefieldhdservices.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldhdservices.features.addshop.presentation.ScanImageFragment
import com.breezefieldhdservices.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldhdservices.features.alarm.model.AlarmData
import com.breezefieldhdservices.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldhdservices.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldhdservices.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldhdservices.features.alarm.presetation.VisitReportFragment
import com.breezefieldhdservices.features.attendance.AttendanceFragment
import com.breezefieldhdservices.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldhdservices.features.attendance.model.AttendanceRequest
import com.breezefieldhdservices.features.attendance.model.AttendanceResponse
import com.breezefieldhdservices.features.averageshop.presentation.AverageShopFragment
import com.breezefieldhdservices.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldhdservices.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldhdservices.features.beatCustom.TeamBeatListFragment
import com.breezefieldhdservices.features.billing.presentation.AddBillingFragment
import com.breezefieldhdservices.features.billing.presentation.BillingDetailsFragment
import com.breezefieldhdservices.features.billing.presentation.BillingListFragment
import com.breezefieldhdservices.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldhdservices.features.chat.model.ChatListDataModel
import com.breezefieldhdservices.features.chat.model.ChatUserDataModel
import com.breezefieldhdservices.features.chat.model.GroupUserDataModel
import com.breezefieldhdservices.features.chat.presentation.*
import com.breezefieldhdservices.features.chatbot.presentation.ChatBotFragment
import com.breezefieldhdservices.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldhdservices.features.chatbot.presentation.ReportsFragment
import com.breezefieldhdservices.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldhdservices.features.commondialog.presentation.CommonDialog
import com.breezefieldhdservices.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldhdservices.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldhdservices.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldhdservices.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldhdservices.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldhdservices.features.contacts.ActivityDtlsFrag
import com.breezefieldhdservices.features.contacts.AddOpptFrag
import com.breezefieldhdservices.features.contacts.ContactDtls
import com.breezefieldhdservices.features.contacts.ContactGr
import com.breezefieldhdservices.features.contacts.ContactsAddFrag
import com.breezefieldhdservices.features.contacts.ContactsFrag
import com.breezefieldhdservices.features.contacts.SchedulerAddFormFrag
import com.breezefieldhdservices.features.contacts.SchedulerViewFrag
import com.breezefieldhdservices.features.contacts.TemplateAddFrag
import com.breezefieldhdservices.features.contacts.TemplateViewFrag
import com.breezefieldhdservices.features.contacts.ViewCrmOpptFrag
import com.breezefieldhdservices.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldhdservices.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldhdservices.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldhdservices.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldhdservices.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldhdservices.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldhdservices.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldhdservices.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldhdservices.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldhdservices.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldhdservices.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldhdservices.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldhdservices.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldhdservices.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldhdservices.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldhdservices.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldhdservices.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldhdservices.features.document.presentation.DocumentListFragment
import com.breezefieldhdservices.features.document.presentation.DocumentTypeListFragment
import com.breezefieldhdservices.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldhdservices.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldhdservices.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldhdservices.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldhdservices.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldhdservices.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldhdservices.features.home.presentation.HomeFragment
import com.breezefieldhdservices.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldhdservices.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldhdservices.features.know_your_state.KnowYourStateFragment
import com.breezefieldhdservices.features.lead.LeadFrag
import com.breezefieldhdservices.features.lead.ViewLeadFrag
import com.breezefieldhdservices.features.leaderboard.LeaderBoardFrag
import com.breezefieldhdservices.features.leaveapplynew.LeaveHome
import com.breezefieldhdservices.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldhdservices.features.localshops.LocalShopListFragment
import com.breezefieldhdservices.features.localshops.LocalShopListMapFragment
import com.breezefieldhdservices.features.localshops.NearByShopsMapFragment
import com.breezefieldhdservices.features.location.*
import com.breezefieldhdservices.features.location.api.LocationRepoProvider
import com.breezefieldhdservices.features.location.model.*
import com.breezefieldhdservices.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldhdservices.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldhdservices.features.login.ShopFeedbackEntity
import com.breezefieldhdservices.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldhdservices.features.login.presentation.LoginActivity
import com.breezefieldhdservices.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldhdservices.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldhdservices.features.marketAssist.MarketAssistTabFrag
import com.breezefieldhdservices.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldhdservices.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldhdservices.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldhdservices.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldhdservices.features.member.MapViewForTeamFrag
import com.breezefieldhdservices.features.member.model.TeamLocDataModel
import com.breezefieldhdservices.features.member.model.TeamShopListDataModel
import com.breezefieldhdservices.features.member.presentation.*
import com.breezefieldhdservices.features.menuBeat.MenuBeatFrag
import com.breezefieldhdservices.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldhdservices.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldhdservices.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldhdservices.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldhdservices.features.myjobs.model.CustomerDataModel
import com.breezefieldhdservices.features.myjobs.presentation.*
import com.breezefieldhdservices.features.myorder.presentation.MyOrderListFragment
import com.breezefieldhdservices.features.myprofile.presentation.MyProfileFragment
import com.breezefieldhdservices.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldhdservices.features.nearbyshops.model.ShopData
import com.breezefieldhdservices.features.nearbyshops.model.ShopListResponse
import com.breezefieldhdservices.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldhdservices.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldhdservices.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldhdservices.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldhdservices.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldhdservices.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldhdservices.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldhdservices.features.newcollection.CollectionShopListFragment
import com.breezefieldhdservices.features.newcollection.NewCollectionListFragment
import com.breezefieldhdservices.features.newcollectionreport.*
import com.breezefieldhdservices.features.notification.NotificationFragment
import com.breezefieldhdservices.features.orderITC.CartListFrag
import com.breezefieldhdservices.features.orderITC.OrderListFrag
import com.breezefieldhdservices.features.orderITC.ProductListFrag
import com.breezefieldhdservices.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldhdservices.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldhdservices.features.orderITC.ViewOrdDtls
import com.breezefieldhdservices.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldhdservices.features.orderList.NewOrderListFragment
import com.breezefieldhdservices.features.orderList.OrderListFragment
import com.breezefieldhdservices.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldhdservices.features.orderhistory.ActivityMapFragment
import com.breezefieldhdservices.features.orderhistory.OrderhistoryFragment
import com.breezefieldhdservices.features.orderhistory.TimeLineFragment
import com.breezefieldhdservices.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldhdservices.features.orderhistory.model.FetchLocationRequest
import com.breezefieldhdservices.features.orderhistory.model.FetchLocationResponse
import com.breezefieldhdservices.features.orderhistory.model.LocationData
import com.breezefieldhdservices.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldhdservices.features.performance.GpsStatusFragment
import com.breezefieldhdservices.features.performance.PerformanceFragment
import com.breezefieldhdservices.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldhdservices.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldhdservices.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldhdservices.features.performanceAPP.PerformanceAppFragment
import com.breezefieldhdservices.features.performanceAPP.allPerformanceFrag
import com.breezefieldhdservices.features.permissionList.ViewPermissionFragment
import com.breezefieldhdservices.features.photoReg.*
import com.breezefieldhdservices.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldhdservices.features.quotation.presentation.*
import com.breezefieldhdservices.features.reimbursement.presentation.*
import com.breezefieldhdservices.features.report.presentation.*
import com.breezefieldhdservices.features.returnsOrder.*
import com.breezefieldhdservices.features.settings.presentation.SettingsFragment
import com.breezefieldhdservices.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldhdservices.features.shopdetail.presentation.*
import com.breezefieldhdservices.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldhdservices.features.stock.StockDetailsFragment
import com.breezefieldhdservices.features.stock.StockListFragment
import com.breezefieldhdservices.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldhdservices.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldhdservices.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldhdservices.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldhdservices.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldhdservices.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldhdservices.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldhdservices.features.survey.SurveyFrag
import com.breezefieldhdservices.features.survey.SurveyViewDtlsFrag
import com.breezefieldhdservices.features.survey.SurveyViewFrag
import com.breezefieldhdservices.features.task.presentation.AddTaskFragment
import com.breezefieldhdservices.features.task.presentation.CalenderTaskFragment
import com.breezefieldhdservices.features.task.presentation.EditTaskFragment
import com.breezefieldhdservices.features.task.presentation.TaskListFragment
import com.breezefieldhdservices.features.taskManagement.TaskManagementFrag
import com.breezefieldhdservices.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldhdservices.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldhdservices.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldhdservices.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldhdservices.features.viewAllOrder.CartFragment
import com.breezefieldhdservices.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldhdservices.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldhdservices.features.viewAllOrder.ViewCartFragment
import com.breezefieldhdservices.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldhdservices.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldhdservices.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldhdservices.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldhdservices.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldhdservices.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldhdservices.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldhdservices.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldhdservices.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldhdservices.features.viewPPDDStock.ViewStockFragment
import com.breezefieldhdservices.features.weather.presentation.WeatherFragment
import com.breezefieldhdservices.mappackage.MapActivity
import com.breezefieldhdservices.mappackage.MapActivityWithoutPath
import com.breezefieldhdservices.mappackage.SendBrod
import com.breezefieldhdservices.widgets.AppCustomEditText
import com.breezefieldhdservices.widgets.AppCustomTextView
...
import com.breezefieldhdservices.features.NewQuotation.ViewAllQuotListFragment.Companion.shop_name
import com.breezefieldhdservices.features.addshop.model.AudioFetchDataCLass
import com.breezefieldhdservices.features.contacts.LoanDtlsFrag
import com.breezefieldhdservices.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldhdservices.features.login.model.NewSettingsResponseModel
import com.breezefieldhdservices.features.performanceAPP.TargetVSAchvFrag
import com.breezefieldhdservices.features.performanceAPP.TargetVSAchvDtlsFrag
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldhdserviceslogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldhdserviceslogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldhdservices/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldhdserviceslogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldhdserviceslogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldhdserviceslogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
