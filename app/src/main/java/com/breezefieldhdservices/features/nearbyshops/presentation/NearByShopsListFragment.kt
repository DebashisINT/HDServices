package com.breezefieldhdservices.features.nearbyshops.presentation
...
import com.breezefieldhdservices.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldhdservices.app.utils.FTStorageUtils
import com.breezefieldhdservices.app.utils.NotificationUtils
...
import com.breezefieldhdservices.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldhdservices.features.addshop.model.QuestionSubmit
import com.breezefieldhdservices.features.addshop.model.UpdateAddrReq
import com.breezefieldhdservices.features.addshop.model.UpdateAddressShop
...
import com.breezefieldhdservices.features.addshop.presentation.*
...
import com.breezefieldhdservices.features.location.model.ShopDurationRequestData
...
import com.breezefieldhdservices.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldhdservices.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldhdservices.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldhdservices.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldhdservices.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldhdservicesApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
