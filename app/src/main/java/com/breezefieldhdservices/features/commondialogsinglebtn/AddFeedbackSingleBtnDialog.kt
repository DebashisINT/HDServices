package com.breezefieldhdservices.features.commondialogsinglebtn
...
import com.breezefieldhdservices.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldhdservices.app.domain.VisitRemarksEntity
...
import com.breezefieldhdservices.features.addshop.presentation.ProspectListDialog
import com.breezefieldhdservices.features.dashboard.presentation.DashboardActivity
import com.breezefieldhdservices.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldhdservices.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldhdservices/files", "recorded_audio${System.currentTimeMillis()}.mp3")
